...
SearchClientFactory.Descriptor = new pip_services3_commons_node_1.Descriptor('pip-services-search', 'factory', 'default', 'default', '1.0');
SearchClientFactory.NullClientV1Descriptor = new pip_services3_commons_node_1.Descriptor('pip-services-search', 'client', 'null', 'default', '1.0');
SearchClientFactory.DirectClientV1Descriptor = new pip_services3_commons_node_1.Descriptor('pip-services-search', 'client', 'direct', 'default', '1.0');
SearchClientFactory.HttpClientV1Descriptor = new pip_services3_commons_node_1.Descriptor('pip-services-search', 'client', 'http', 'default', '1.0');
